...
# Now set the environment variables VIRTUAL_ENV, FLASK_APP, and FLASK_DEBUG used by many tools to determine
# that there is an activated venv, set app name and set debug mode on as default.
